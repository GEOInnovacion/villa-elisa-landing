    ...
    faqs: [
      {
        ...
        answer:
          "Villa Elisa se encuentra en Manuel Ugarteche 401, Selva Alegre, Arequipa, Perú — cerca del Puente Grau y el Museo de Arte Virreinal de Santa Teresa, con fácil acceso a la Plaza de Armas.",
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Villa Elisa is located at Manuel Ugarteche 401, Selva Alegre, Arequipa, Peru — near Puente Grau and the Museum of Viceroyal Art of Santa Teresa, with easy access to the Plaza de Armas.",
      },
      {
